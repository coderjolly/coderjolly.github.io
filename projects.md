...
**News Recommendation System** [**[<font color='blue'>Github</font>]**](https://github.com/coderjolly/news-recommender)
<br/>
...
``With proper sound detection and classification, researchers can understand what birdcall signal the birds use, in order to communicate with each other or to warn others about the impending dangers in the vicinity. So, Mel Spectrograms, a feature extraction method for audio-related projects is used to feed them to a CNN model in order to classify bird species.``


**We Care (findHelp)** [**[<font color='blue'>Github</font>]**](https://github.com/coderjolly/find-help)
<br/>

``A backend application based on Java Spring Boot that caters to the need of collecting data for patients with depression. Patients are able to register themselves , perform self assessment in order to get help from a cunsellor or doctor. This self-assessment data will be communicated to counsellor or doctor and then appropriate action will be taken accordingly. ``


**DonorFu** [**[<font color='blue'>Devpost</font>]**](https://devpost.com/software/donorfu)
<br/>

``We find many groups on facebook catering to blood requests. Some groups are highly active and thus cluttered with requests, others dormant & requests are unanswered. DonorFu, a facebook messenger bot leveraging access to groups approved by admins to match posts with potential donors to manage these groups which won $17,500 at FB Developer Community Challenge.``


**Sociogram** [**[<font color='blue'>Github</font>]**](https://github.com/coderjolly/sociogram)
<br/>
...
``This provides a small glimpse of the SERC'sresource data demonstrating how data was ingested and extracted to produce relevant results for data analysis between actual resource utilization and simulated resource utilization.``
