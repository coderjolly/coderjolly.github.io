...
[``Chest X-Ray Classification``](articles/22/chest-x-ray){:target="_blank"}<br/>
This writing is a comprehensive analysis of my learnings and collaborative efforts of my team throughout the Applied Artificial Intelligence course by using deep learning architectures for classifying thoracic diseases as a final project to be delivered. It is a brief writing of the project, the dataset, the models used, the results obtained and visualization involved throughout the project.


[``macOS Setup Guide``](articles/22/macOS-setup-guide){:target="_blank"}<br/>
