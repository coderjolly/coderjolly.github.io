...
[``EEG Signal Analysis``](articles/22/eeg-exploration){:target="_blank"}<br/>
...
<p style="text-align:left;">
    <a href="articles/22/macOS-setup-guide" style="font-family: 'cascadia'; font-size: 1.02rem; border-radius: 3px; color: #a00000; font-weight: 500; text-decoration: nonw; border-bottom:2px solid black">macOS Setup Guide</a>
    <!-- <span style="float:right; font-family: 'cascadia'; font-size: 1.02rem; border-radius: 3px; color: #a00000; font-weight: 500;">
        28th December 2022
    </span> -->
</p>
