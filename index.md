...
During my tenure, I have contributed to several divisions of tech using `machine learning techniques & natural language processing (NLP)`. Additionally, I have designed large-scale data ingestion & transformation `ETL pipelines/ML pipelines using Databricks & PySpark` for automated CI/CD deployment on cloud services. 
...
<ul style="padding: 0; margin: 0; list-style-position: outside; width: 100%; position: relative;">
  ...
  <li style="list-style-type: disc; margin-left: 1em; position: relative; margin-top: 0.5em; padding-right: 120px;">
    ...
    <span style="font-weight: bold; white-space: nowrap; position: absolute; right: 140px; top: 0;">Jan 2021 – Aug 2022</span>
  </li>
...
<ul style="padding: 0; margin: 0; list-style-position: outside; width: 100%; position: relative;">
  ...
  <li style="margin-left: 0.5em; position: relative; padding-right: 120px;">
    ...
    <span style="font-weight: bold; white-space: nowrap; position: absolute; right: 140px; top: 0;">Jan 2019 – April 2019</span>
  </li>
